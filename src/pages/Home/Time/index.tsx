...
const Roadmap = () => {
  useEffect(() => {
    ...
    tl.to('.dots:not(.dot-one):not(.dot-two):not(.dot-three)', {
      rotate: '+=30',
    });
    ...
    tl.to('.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four', {
      rotate: '+=30',
    });
    tl.to('.dots.dot-four > span', { top: 160 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-five > span', { top: 140 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five, .dots.dot-six',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-six > span', { top: 120 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five, .dots.dot-six, .dots.dot-seven',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-seven > span', { top: 100 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five, .dots.dot-six, .dots.dot-seven, .dots.dot-eight',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-eight > span', { top: 80 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five, .dots.dot-six, .dots.dot-seven, .dots.dot-eight, .dots.dot-nine',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-nine > span', { top: 60 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five, .dots.dot-six, .dots.dot-seven, .dots.dot-eight, .dots.dot-nine, .dots.dot-ten',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-ten > span', { top: 40 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five, .dots.dot-six, .dots.dot-seven, .dots.dot-eight, .dots.dot-nine, .dots.dot-ten, .dots.dot-eleven',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-eleven > span', { top: 20 }, '<');

    tl.to(
      '.dots.dot-one, .dots.dot-two, .dots.dot-three, .dots.dot-four, .dots.dot-five, .dots.dot-six, .dots.dot-seven, .dots.dot-eight, .dots.dot-nine, .dots.dot-ten, .dots.dot-eleven, .dots.dot-twelve',
      { rotate: '+=30' },
    );
    tl.to('.dots.dot-twelve > span', { top: 0 }, '<');
  }, []);
  return (
    <div className={styles.banner}>
      <div className="loader-cont">
        <div className="dots dot-one">
          <span></span>
        </div>
        <div className="dots dot-two">
          <span></span>
        </div>
        <div className="dots dot-three">
          <span></span>
        </div>
        <div className="dots dot-four">
          <span></span>
        </div>
        <div className="dots dot-five">
          <span></span>
        </div>
        <div className="dots dot-six">
          <span></span>
        </div>
        <div className="dots dot-seven">
          <span></span>
        </div>
        <div className="dots dot-eight">
          <span></span>
        </div>
        <div className="dots dot-nine">
          <span></span>
        </div>
        <div className="dots dot-ten">
          <span></span>
        </div>
        <div className="dots dot-eleven">
          <span></span>
        </div>
        <div className="dots dot-twelve">
          <span></span>
        </div>
      </div>
    </div>
